const PUBLIC_ORIGIN = 'https://staff.jayabina.com';
const PAGES_ORIGIN = 'https://www.jayabina.com';
const APP_PATH = '/worker/';

function rewritePublicUrl(value) {
  return value
    .replaceAll(PAGES_ORIGIN, PUBLIC_ORIGIN)
    .replaceAll('https:\\/\\/www.jayabina.com', 'https:\\/\\/staff.jayabina.com');
}
...
export default {
  async fetch(request) {
    ...
    upstreamUrl.hostname = 'www.jayabina.com';
    upstreamUrl.port = '';
